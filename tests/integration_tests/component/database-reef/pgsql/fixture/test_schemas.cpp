...
DROP TABLE IF EXISTS users;
    ...
    std::string_view SchemaDDL::users_table(reef::Providers dialect) {
        switch (dialect) {
            case reef::Providers::PostgreSQL:
    ...
    std::string_view SchemaDDL::users_extended_table(reef::Providers dialect) {
        switch (dialect) {
            case reef::Providers::PostgreSQL:
    ...
    std::string_view SchemaDDL::posts_table(reef::Providers dialect) {
        switch (dialect) {
            case reef::Providers::PostgreSQL:
    ...
    std::string_view SchemaDDL::orders_table(reef::Providers dialect) {
        switch (dialect) {
            case reef::Providers::PostgreSQL:
    ...
    std::string_view SchemaDDL::orders_extended_table(reef::Providers dialect) {
        switch (dialect) {
            case reef::Providers::PostgreSQL:
    ...
    std::string_view SchemaDDL::comments_table(reef::Providers dialect) {
        switch (dialect) {
            case reef::Providers::PostgreSQL:
    ...
    std::string_view SchemaDDL::drop_all(reef::Providers dialect) {
        switch (dialect) {
            case reef::Providers::PostgreSQL:
    ...
    TestSchemas TestSchemas::create(reef::Providers provider) {
        // Build a DynamicTable for Record-based tests
        auto users_dyn = std::make_shared<reef::DynamicTable>("users", provider);
