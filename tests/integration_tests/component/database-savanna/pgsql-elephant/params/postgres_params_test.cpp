...
using elephant::FormatRegistry;
using elephant::OidTypeRegistry;
...
TEST_F(PostgresParamsTest, InsertAndSelect) {
    ...
    elephant::ParamSink insert_sink(&pool);
    ...
    elephant::ParamSink select_sink(&pool);
