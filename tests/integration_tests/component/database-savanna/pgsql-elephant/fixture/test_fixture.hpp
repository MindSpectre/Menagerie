...
namespace menagerie::test {
    ...
    protected:
        void SetUp() override {
            ...
            executor_ = std::make_unique<savanna::elephant::SyncExecutor>(conn_);
            schemas_  = std::make_unique<TestSchemas>(TestSchemas::create(savanna::Providers::PostgreSQL));
        }
        ...
        [[nodiscard]] savanna::CompiledDynamicQuery compile_query(ExprTp&& expr) {
        ...
        void ConnectToDatabase() {
            const auto credentials = savanna::elephant::ConnectionCredentials::Builder{}
        ...
        [[nodiscard]] savanna::elephant::SyncExecutor& executor() const {
            return *executor_;
        }
        ...
        std::unique_ptr<savanna::elephant::SyncExecutor> executor_;
        std::unique_ptr<TestSchemas> schemas_;
        savanna::QueryCompiler<savanna::elephant::PostgresDialect, savanna::ParamMode::Inline> compiler_{};
    };
