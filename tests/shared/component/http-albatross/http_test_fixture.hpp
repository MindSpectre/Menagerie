...
namespace http_it {
    ...
    protected:
        ...
        menagerie::albatross::RouteRegistry registry_;
        std::vector<std::shared_ptr<menagerie::albatross::HttpController>> controllers_;
        std::optional<menagerie::albatross::Router> router_;
        std::unique_ptr<menagerie::albatross::ListenerBase> listener_;
        ...
        void add_controller(std::shared_ptr<menagerie::albatross::HttpController> ctrl) {
            menagerie::albatross::GroupBinding{registry_, controllers_, ""}.add_controller(std::move(ctrl));
        }

        /// Freeze routes, bind the listener, go live on the worker thread.
        void start(std::unique_ptr<menagerie::albatross::ListenerBase> listener) {
        ...
        std::unique_ptr<menagerie::albatross::ListenerBase> make_tcp_listener() {
            return std::make_unique<menagerie::albatross::TcpListener<menagerie::albatross::Http11Driver>>(
                std::vector{ioc_.get_executor()},
                "127.0.0.1",
                0,
                menagerie::albatross::Http11Driver{menagerie::albatross::Http11Config{}});
        }
