...
using menagerie::starling::detail::WaiterList;
using menagerie::starling::detail::WaiterNode;
using menagerie::starling::detail::WaitOutcome;
using menagerie::starling::detail::WaitState;
...
using menagerie::starling::AsyncLease;
...
using menagerie::starling::AsyncResourcePool;
