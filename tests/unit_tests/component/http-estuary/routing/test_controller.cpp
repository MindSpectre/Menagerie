...
namespace myapp {
    ...
    inline menagerie::estuary::Response to_http_response(const TeapotError& e) {
        return menagerie::estuary::ResponseFactory::custom(menagerie::estuary::HttpStatus::unprocessable_entity,
                                                        "teapot:" + e.blend);
    }
