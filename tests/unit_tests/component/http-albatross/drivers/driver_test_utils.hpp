...
namespace http_driver_test {
    ...
    public:
        ...
        boost::asio::awaitable<void, menagerie::albatross::Strand> async_close() {
            stream_.close();
            co_return;
        }
        ...
        [[nodiscard]] static menagerie::albatross::Protocol negotiated_protocol() noexcept {
            return menagerie::albatross::Protocol::http1;
        }
    ...
    private:
        stream_type stream_;
        menagerie::albatross::RequestArena arena_;
        boost::asio::cancellation_signal signal_;
    };

    static_assert(menagerie::albatross::IsStreamConnection<TestConnection>);
    ...
    std::vector<ParsedResponse> exchange(Driver& driver,
                                         menagerie::albatross::Router& router,
