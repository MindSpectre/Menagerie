...
namespace myapp {
    ...
    inline menagerie::albatross::Response to_http_response(const TeapotError& e) {
        return menagerie::albatross::ResponseFactory::custom(menagerie::albatross::HttpStatus::unprocessable_entity,
                                                        "teapot:" + e.blend);
    }
