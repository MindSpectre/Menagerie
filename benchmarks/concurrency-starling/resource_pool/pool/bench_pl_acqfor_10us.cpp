...
int main(int argc, char** argv) {
    ...
    auto strategy  = [](PoolT& p) { return p.acquire_for(std::chrono::microseconds{10}); };
    return run_sync_bench_main<PoolT>(argc, argv, "PL_AcqFor_10us", FREE_REGION_SCENARIOS, make_pool, strategy);
}
