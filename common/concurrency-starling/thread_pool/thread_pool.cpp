...
void menagerie::starling::ThreadPool::create_worker() {
...
void menagerie::starling::ThreadPool::start_cleanup_thread() {
...
void menagerie::starling::ThreadPool::cleanup_invalid_workers() {
...
void menagerie::starling::ThreadPool::shutdown() {
    {
        std::unique_lock lock(task_queue_mutex_);
        stop_ = true;
    }
...
menagerie::starling::ThreadPool::~ThreadPool() {
    shutdown();
}
