...
The savanna component (`component/database-savanna/`) is a layered PostgreSQL client. A provider-agnostic core --
...
- **`query/`**: the expression tree
  ...
  selects).
- **`providers/postgresql-elephant/`**: the only implemented provider,
